...
function twentysixteen_setup() {
	...
	// This theme uses wp_nav_menu() in two locations Bootstrap.
...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
		...
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title titulo">',
		'after_title'   => '</h2>',
	) );
}
...
function twentysixteen_scripts() {
	...
	wp_enqueue_style( 'twentysixteen-style-new', get_template_directory_uri() . '/sass/styles.css', array( 'twentysixteen-style' ), '20160412' );

	// Theme carousel.
	wp_enqueue_style( 'twentysixteen-carousel', get_template_directory_uri() . '/sass/owl.carousel.css', array( 'twentysixteen-style' ), '20160412' );
	...
	//Load js bootstrap
	wp_enqueue_script( 'twentysixteen-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '3.7.3' );

	//Load js carousel
	wp_enqueue_script( 'twentysixteen-carousel', get_template_directory_uri() . '/js/owl.carousel.min.js', array(), '3.7.3' );

	//Load js site
	wp_enqueue_script( 'twentysixteen-site', get_template_directory_uri() . '/js/scripts.js', array(), '3.7.3' );
