...
// speciarias por Ordem

add_action('init', 'type_post_esp_ordem');

  function type_post_esp_ordem() {
    $labels = array(
      'name' => _x('EspeciariasOrdem', 'post type general name'),
      'singular_name' => _x('Especiarias', 'post type singular name'),
      'add_new' => _x('Adicionar Novo', 'Novo item'),
      'add_new_item' => __('Novo Item'),
      'edit_item' => __('Editar Item'),
      'new_item' => __('Novo Item'),
...
register_post_type( 'EspeciariasOrdem' , $args );
flush_rewrite_rules();
}


//END Especiarias por Ordem

// speciarias por Ordem

add_action('init', 'type_post_receitas');
...
function cmb2_sample_metaboxes(){
  ...
  $cmb->add_field( array(
      'name'    => 'Linha Fina',
      'desc'    => 'Texto com um pouco mais de informações',
      //'default' => 'standard value (optional)',
      'id'      => '_wiki_test_linhafina',
      'type'    => 'text'
  ) );
  ...
  $cmb->add_field( array(
      ...
      'post_type'   => array( 'EspeciariasOrdem','Agenda','EspeciariasHistoria', 'post'),
...
// // Video
// add_action( 'cmb2_init', 'cmb2_esp_video' );
//
// function cmb2_esp_video(){
//   $prefix = '_my_prefix_';
//
//   // Classic CMB2 declaration
//   $cmb2_video = new_cmb2_box( array(
//       'id'           => 'prefix-metabox-id-video',
//       'title'        => __( 'Mais informações' ),
...
//
// // Quote
// add_action( 'cmb2_init', 'cmb2_esp_quote' );
//
// function cmb2_esp_quote(){
//   $prefix = '_my_prefix_';
//
//   // Classic CMB2 declaration
//   $cmb2_quote = new_cmb2_box( array(
//       'id'           => 'prefix-metabox-id-quode',
//       'title'        => __( 'Quate' ),
//       'object_types' => array( 'post'), // Post type
